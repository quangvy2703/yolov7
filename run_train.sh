...
python train.py --workers 8 --device 0 --batch-size 16 --data data/custom.yaml --img 512 512 --cfg cfg/training/yolov7x.yaml --weights 'pretrained/yolov7x_training.pt' --name yolov7x_8classes_watermark --hyp data/hyp.scratch.custom.yaml --resume
